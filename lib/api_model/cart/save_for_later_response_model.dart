...
//
//     final getAddSaveForLaterResponseModel = getAddSaveForLaterResponseModelFromJson(jsonString);

import 'dart:convert';

GetAddSaveForLaterResponseModel getAddSaveForLaterResponseModelFromJson(String str) => GetAddSaveForLaterResponseModel.fromJson(json.decode(str));

String getAddSaveForLaterResponseModelToJson(GetAddSaveForLaterResponseModel data) => json.encode(data.toJson());

class GetAddSaveForLaterResponseModel {
  GetAddSaveForLaterResponseModel({
    required this.error,
  ...
  factory GetAddSaveForLaterResponseModel.fromJson(Map<String, dynamic> json) => GetAddSaveForLaterResponseModel(
    error: json["error"],
