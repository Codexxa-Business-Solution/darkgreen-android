...
GetAddSaveForLaterResponseModel getAddSaveForLaterResponseModelFromJson(
        String str) =>
    GetAddSaveForLaterResponseModel.fromJson(json.decode(str));

String getAddSaveForLaterResponseModelToJson(
        GetAddSaveForLaterResponseModel data) =>
...
class GetAddSaveForLaterResponseModel {
  ...
  factory GetAddSaveForLaterResponseModel.fromJson(Map<String, dynamic> json) =>
      GetAddSaveForLaterResponseModel(
        error: json["error"],
