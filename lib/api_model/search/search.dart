...
GetSearchProductResponseModel getSearchProductResponseModelFromJson(
        String str) =>
    GetSearchProductResponseModel.fromJson(json.decode(str));

String getSearchProductResponseModelToJson(
        GetSearchProductResponseModel data) =>
...
class GetSearchProductResponseModel {
  ...
  factory GetSearchProductResponseModel.fromJson(Map<String, dynamic> json) =>
      GetSearchProductResponseModel(
        error: json["error"],
