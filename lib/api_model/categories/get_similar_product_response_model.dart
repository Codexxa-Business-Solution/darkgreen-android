...
GetSimilarProductResponseModel getSimilarProductResponseModelFromJson(
        String str) =>
    GetSimilarProductResponseModel.fromJson(json.decode(str));

String getSimilarProductResponseModelToJson(
        GetSimilarProductResponseModel data) =>
...
class GetSimilarProductResponseModel {
  ...
  factory GetSimilarProductResponseModel.fromJson(Map<String, dynamic> json) =>
      GetSimilarProductResponseModel(
        error: json["error"],
