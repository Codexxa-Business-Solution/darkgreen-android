...
//
//     final getSimilarProductResponseModel = getSimilarProductResponseModelFromJson(jsonString);

import 'dart:convert';

GetSimilarProductResponseModel getSimilarProductResponseModelFromJson(String str) => GetSimilarProductResponseModel.fromJson(json.decode(str));

String getSimilarProductResponseModelToJson(GetSimilarProductResponseModel data) => json.encode(data.toJson());

class GetSimilarProductResponseModel {
  GetSimilarProductResponseModel({
    required this.error,
  ...
  factory GetSimilarProductResponseModel.fromJson(Map<String, dynamic> json) => GetSimilarProductResponseModel(
    error: json["error"],
