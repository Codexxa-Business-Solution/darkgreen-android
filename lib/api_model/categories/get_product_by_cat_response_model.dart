...
GetProductsByCategoriesResponseModel
    getProductsByCategoriesResponseModelFromJson(String str) =>
        GetProductsByCategoriesResponseModel.fromJson(json.decode(str));

String getProductsByCategoriesResponseModelToJson(
        GetProductsByCategoriesResponseModel data) =>
...
class GetProductsByCategoriesResponseModel {
  ...
  factory GetProductsByCategoriesResponseModel.fromJson(
