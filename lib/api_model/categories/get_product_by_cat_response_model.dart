...
//
//     final getProductsByCategoriesResponseModel = getProductsByCategoriesResponseModelFromJson(jsonString);

import 'dart:convert';

GetProductsByCategoriesResponseModel getProductsByCategoriesResponseModelFromJson(String str) => GetProductsByCategoriesResponseModel.fromJson(json.decode(str));

String getProductsByCategoriesResponseModelToJson(GetProductsByCategoriesResponseModel data) => json.encode(data.toJson());

class GetProductsByCategoriesResponseModel {
  GetProductsByCategoriesResponseModel({
    required this.error,
  ...
  factory GetProductsByCategoriesResponseModel.fromJson(Map<String, dynamic> json) => GetProductsByCategoriesResponseModel(
    error: json["error"],
