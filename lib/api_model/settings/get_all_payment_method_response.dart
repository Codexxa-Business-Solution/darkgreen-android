...
GetPaymentMethodResponseModel getPaymentMethodResponseModelFromJson(
        String str) =>
    GetPaymentMethodResponseModel.fromJson(json.decode(str));

String getPaymentMethodResponseModelToJson(
        GetPaymentMethodResponseModel data) =>
...
class GetPaymentMethodResponseModel {
  ...
  factory GetPaymentMethodResponseModel.fromJson(Map<String, dynamic> json) =>
      GetPaymentMethodResponseModel(
        error: json["error"],
