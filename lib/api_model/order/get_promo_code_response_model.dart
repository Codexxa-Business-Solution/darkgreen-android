...
GetPromoCodeResponseModel getPromoCodeResponseModelFromJson(String str) =>
    GetPromoCodeResponseModel.fromJson(json.decode(str));

String getPromoCodeResponseModelToJson(GetPromoCodeResponseModel data) =>
...
class GetPromoCodeResponseModel {
  ...
  factory GetPromoCodeResponseModel.fromJson(Map<String, dynamic> json) =>
      GetPromoCodeResponseModel(
        error: json["error"],
        total: json["total"],
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        isValidate: List<IsValidate>.from(
            json["is_validate"].map((x) => IsValidate.fromJson(x))),
      );
