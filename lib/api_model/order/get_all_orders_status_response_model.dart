...
GetOredersStatusResponseModel getOrdersStatusResponseModelFromJson(
        String str) =>
    GetOredersStatusResponseModel.fromJson(json.decode(str));

String getOredersStatusResponseModelToJson(
        GetOredersStatusResponseModel data) =>
...
class GetOredersStatusResponseModel {
  ...
  factory GetOredersStatusResponseModel.fromJson(Map<String, dynamic> json) =>
      GetOredersStatusResponseModel(
        error: json["error"],
        total: json["total"],
