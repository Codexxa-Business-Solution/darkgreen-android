...
class _ChangePasswordState extends State<ChangePassword> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      height: _oldPasswordFocus.hasFocus || _newPasswordFocus.hasFocus
          || _confirmPasswordFocus.hasFocus ?
      SizeConfig.screenHeight*0.75 : SizeConfig.screenHeight*0.4,
            ...
            Padding(
              ...
              child: TextFormField(
                decoration:  InputDecoration(
                   ...
                   prefixIcon: Icon(Icons.lock),
                    suffixIcon:newPaswordShow ? GestureDetector(
                      onDoubleTap: (){},
                      onTap: (){
                        _newToggle();
                      },
            ...
            Padding(
              ...
              child: TextFormField(
                decoration:  InputDecoration(
                   ...
                   prefixIcon: Icon(Icons.lock),
                    suffixIcon:confirmPaswordShow ? GestureDetector(
                      onDoubleTap: (){},
                      onTap: (){
                        _confirmToggle();
                      },
