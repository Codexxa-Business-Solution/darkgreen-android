...
class DoorStepOrder extends StatefulWidget {
  ...
  const DoorStepOrder({Key? key, required this.model, required this.index}) : super(key: key);
...
class _DoorStepOrderState extends State<DoorStepOrder> {
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          AllCommonApis().getInvoiceOrder(widget.model.data[widget.index].id);
                        },
                        child: Container(
                          height: SizeConfig.screenHeight*0.06,
                          width: SizeConfig.screenWidth*0.45,
  ...
  Widget allDetailsLayout(double parentHeight, double parentWidth){
    ...
    placeDate =  DateFormat.yMd().add_jm().format(widget.model.data[widget.index].orderTime);
            ...
            sliver: SliverList(
                delegate: SliverChildBuilderDelegate(
                  childCount: widget.model.data[widget.index].items.length,
                    ...
                    final img = widget.model.data[widget.index].items[index1].image.isNotEmpty
                        ? Image.network(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Text(widget.model.data[widget.index].items[index1].name,
                                            style: TextStyle(
                                                color: Colors.black,
                                                fontSize: SizeConfig.blockSizeHorizontal*4.0,
                                                fontFamily: 'Roboto_Regular',
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(widget.model.data[widget.index].items[index1].quantity,
                                                style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: SizeConfig.blockSizeHorizontal*4.0,
                                                    fontFamily: 'Roboto_Medium',
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.start,
                                            children: [
                                              Text("\u20B9${widget.model.data[widget.index].items[index1].subTotal}",
                                                style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: SizeConfig.blockSizeHorizontal*4.0,
                                                    fontFamily: 'Roboto_Medium',
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.start,
                                            children: [
                                              Text(widget.model.data[widget.index].paymentMethod == "Cash Method" ? "Via C.O.D." : "Online Payment",
                                                style: TextStyle(
                                                    color: CommonColor.APP_BAR_COLOR,
                                                    fontSize: SizeConfig.blockSizeHorizontal*4.0,
                                                    fontFamily: 'Roboto_Medium',
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.start,
                                            children: [
                                              Text(widget.model.data[widget.index].items[index1].tillStatus.toString().toUpperCase(),
                                                style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: SizeConfig.blockSizeHorizontal*4.0,
                                                    fontFamily: 'Roboto_Regular',
                ...
                [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          widget.model.data[widget.index].address,
                                          style: TextStyle(
                                              color: Colors.black,
                                              fontSize: SizeConfig.blockSizeHorizontal*4.0,
                                              fontWeight: FontWeight.w400,
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Text(
                                    widget.model.data[widget.index].activeStatus == "awaiting_payment" ? "Order Awaiting Approval" :
                                    widget.model.data[widget.index].activeStatus == "pending" ? "Order Pending" :
                                    widget.model.data[widget.index].activeStatus == "received" ? "Order Received" :
                                    widget.model.data[widget.index].activeStatus == "processed" ? "Order Processed" :
                                    widget.model.data[widget.index].activeStatus == "shipped" ? "Order Shipped" :
                                    widget.model.data[widget.index].activeStatus == "delivered" ? "Order Delivered" :
                                    widget.model.data[widget.index].activeStatus == "cancelled" ? "Order Cancelled" :
                                    widget.model.data[widget.index].activeStatus == "returned" ? "Order Returned" :"",
                                    style: TextStyle(
                                        color: Colors.black,
                                        fontSize: SizeConfig.blockSizeHorizontal*4.0,
                                        fontWeight: FontWeight.w400,
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    width: parentWidth*0.22,
                                    child: Text(
                                      widget.model.data[widget.index].deliveryTime,
                                      style: TextStyle(
                                          color: Colors.black,
                                          fontSize: SizeConfig.blockSizeHorizontal*4.0,
                                          fontWeight: FontWeight.w400,
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        AllCommonApis().getOrderDelete(widget.model.data[widget.index].id).then((value){
                          print(value.message);
